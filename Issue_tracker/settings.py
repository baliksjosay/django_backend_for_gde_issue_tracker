...
SECRET_KEY = '%7066o5j@x3^bq(wfma1f-abj(gdp948ijmll4!9(bhi4%4=p0'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'baliks$issue_tracker',
        'USER': 'baliks',
        'PASSWORD': 'namayanja',
        'HOST': 'baliks.mysql.pythonanywhere-services.com',
        # 'TEST': {
        #   'NAME': 'baliks$test_issuetracker',
        # }
    # 'default': {
...
EMAIL_HOST_PASSWORD = 'oxzslzkfjaqnxqzp'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
