# [React Reduction - Free Admin Template Built with React and Bootstrap4](http://ugpmudigapp01.mtn.co.ug:8086//)

![React Reduction](public/img/screenshots/reduction-admin.jpg?raw=true 'React Reduction')

## Preview

You can check out [live preview](http://ugpmudigapp01.mtn.co.ug:8086//).
